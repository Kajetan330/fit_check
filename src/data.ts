...
const fashionServices: Service[] = [
  {
    ...
    notFor: ["Full closet rebuilds", "Multi-event capsules"],
    youSend: "One outfit question plus up to five photos of the piece, outfit, or occasion context.",
    youReceive: "A clear creator verdict, three specific styling changes, and one purchase or wear-with call.",
    customerEffortMins: 8,
    revisionTerms: "One clarification within 72 hours is included.",
    exampleResultImage: image("photo-1516762689617-e1cffcef479d"),
  ...
  },
  {
    ...
    notFor: ["Urgent event decisions", "Full shopping lists"],
    youSend: "Three to six current outfit photos, two references, and what feels off right now.",
    youReceive: "A written style read with palette, silhouette, texture, and next-step direction.",
    customerEffortMins: 15,
    revisionTerms: "One clarification within 72 hours is included.",
    exampleResultImage: image("photo-1485968579580-b6d095142e6e"),
  ...
  },
  {
    ...
    notFor: ["Instant replies", "Occasions needing only one outfit"],
    youSend: "Clear photos of the closet pieces you actually wear, plus your goal and budget boundaries.",
    youReceive: "Keep, repair, donate, and outfit calls built from your real wardrobe.",
    customerEffortMins: 30,
    revisionTerms: "One revision within the original closet scope is included.",
    exampleResultImage: image("photo-1487412720507-e7ab37603c6f"),
  ...
  },
  {
    ...
    notFor: ["No-buy styling", "One-piece verdicts"],
    youSend: "Budget, sizes, style references, no-go brands, and what the capsule must cover.",
    youReceive: "A focused shopping edit with budget tiers, styling notes, and substitution logic.",
    customerEffortMins: 20,
    revisionTerms: "One substitution pass within 72 hours is included.",
    exampleResultImage: image("photo-1523398002811-999ca8dec234"),
